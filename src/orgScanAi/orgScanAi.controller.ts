...
export class OrgScanAiController {
  ...
  async analyzeOrganization(
    ...
    // TODO: Add image format support (requires OCR implementation)
    // Current limitation: pdf-parse only supports PDF format
    // For images, integrate: Tesseract.js, Google Vision API, or similar OCR library
  ...
  getStats(): Promise<AnalysisStatsResponse> {
